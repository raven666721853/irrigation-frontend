...
const S = {
  ...
  layout: { display:"flex", minHeight:"calc(100vh - 66px)", flexDirection: window.innerWidth < 768 ? "column" : "row" },
  sidebar: { width: window.innerWidth < 768 ? "100%" : 200, background:"#0b1120", borderRight:"1px solid #1a2540", borderBottom: window.innerWidth < 768 ? "1px solid #1a2540" : "none", padding: window.innerWidth < 768 ? "8px 0" : "16px 0", display:"flex", flexDirection: window.innerWidth < 768 ? "row" : "column", flexShrink:0, overflowX: window.innerWidth < 768 ? "auto" : "visible", flexWrap:"nowrap" },
  navItem: { display:"flex", alignItems:"center", gap:10, padding: window.innerWidth < 768 ? "8px 14px" : "10px 20px", background:"transparent", border:"none", color:"#6b7280", cursor:"pointer", fontSize: window.innerWidth < 768 ? 12 : 13, fontWeight:500, textAlign:"left", position:"relative", transition:"all 0.15s", whiteSpace:"nowrap" },
